...
class PriorityQueue_deque_backwards:
...
from heapq import heappush, heappop
import itertools
class PriorityQueue_heap_itertools:
...
class PriorityQueue_parallel_heap:
...
class PriorityQueue_not_so_slow:
